...
plt.plot(T1, yout, "k-", label="noise observation of x")
plt.plot(T2, xtrue[:, 0], "r--", label="true system state of x")
plt.plot(T2, xtrue[:, 1], "g--", label="true system state of x_dot")
plt.plot(T2, xtrue[:, 2], "b--", label="true system state of theta")
plt.plot(T2, xtrue[:, 3], "y--", label="true system state of theta_dot")
plt.plot(T3, xk[:, 0], "y-", label="kalman estimation of x")
plt.plot(T3, xk[:, 1], "r-", label="kalman estimation of x_dot")
plt.plot(T3, xk[:, 2], "g-", label="kalman estimation of theta")
plt.plot(T3, xk[:, 3], "b-", label="kalman estimation of theta_dot")
plt.title('Kalman estimator output for each state')
